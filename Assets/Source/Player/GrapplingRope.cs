...
public class GrapplingRope : MonoBehaviour
{
    ...
    void DrawRope()
    {
        ...
        {
            currentGrapplePosition = playerController.gunTip.position;
        ...
        Vector3 grapplePoint = playerController.GetGrapplePoint();
        Vector3 gunTipPosition = playerController.gunTip.position;
